...
import antlr4.tauris.TExprBaseVisitor;
import antlr4.tauris.TExprLexer;
import antlr4.tauris.TExprParser;
...
public abstract class TExpression {
    ...
    public abstract Object eval(TObject e);

    public Number calc(TObject e) {
    ...
    public Boolean check(TObject e) {
        Object ret = this.eval(e);
        if (ret == null) {
            return false;
        }
    ...
    public static TExpression build(String expr) {
    ...
    private static class ExpressionVisitor extends TExprBaseVisitor<TExpression> {
        ...
        public TExpression visitBit(TExprParser.BitContext ctx) {
            ...
            if (ctx.BAND() != null) {
                return new CalcExpression(left, right, "&", (l, r) -> l.longValue() & r.longValue());
            }
            if (ctx.BEOR() != null) {
                return new CalcExpression(left, right, "^", (l, r) -> l.longValue() ^ r.longValue());
            }
        ...
        public TExpression visitShift(TExprParser.ShiftContext ctx) {
            ...
            if (ctx.LSHIFT() != null) {
                return new CalcExpression(left, right, "<<", (l, r) -> l.longValue() << r.intValue());
            }
            if (ctx.RSHIFT() != null) {
                return new CalcExpression(left, right, ">>", (l, r) -> l.longValue() >> r.intValue());
            }
        ...
        public TExpression visitPlus(TExprParser.PlusContext ctx) {
            ...
            if (ctx.MINUS() != null) {
                return new CalcExpression(left, right, "-", (l, r) -> l.doubleValue() - r.doubleValue());
        ...
        public TExpression visitMultiplying(TExprParser.MultiplyingContext ctx) {
            ...
            if (ctx.DIV() != null) {
                ...
                return new CalcExpression(left, right, "%", (l, r) -> l.doubleValue() % r.longValue());
            }
            return right;
        }
