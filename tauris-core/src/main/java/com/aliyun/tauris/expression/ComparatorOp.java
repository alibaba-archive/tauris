...
public abstract class ComparatorOp {
    ...
    public abstract Comparable eval(TObject e, TExpression left, TExpression right);

    private static int compare(TObject e, TExpression left, TExpression right) {
    ...
    private static class GT extends ComparatorOp {
        ...
        @Override
        public Comparable eval(TObject e, TExpression left, TExpression right) {
