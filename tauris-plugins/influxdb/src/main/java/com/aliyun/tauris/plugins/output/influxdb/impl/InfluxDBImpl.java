package com.aliyun.tauris.plugins.output.influxdb.impl;
...
import com.aliyun.tauris.plugins.output.influxdb.dto.Pong;
import com.aliyun.tauris.plugins.output.influxdb.dto.Query;
import com.aliyun.tauris.plugins.output.influxdb.dto.QueryResult;
import com.aliyun.tauris.plugins.output.influxdb.impl.BatchProcessor.HttpBatchEntry;
import com.aliyun.tauris.plugins.output.influxdb.impl.BatchProcessor.UdpBatchEntry;
            ...
            public void onResponse(final Call<ResponseBody> call, final Response<ResponseBody> response) {
                try {
                    ...
                    try (ResponseBody errorBody = response.errorBody()) {
                        throw new InfluxDBException(response.code(), errorBody.string());
                    }
