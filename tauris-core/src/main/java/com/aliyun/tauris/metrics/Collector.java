...
public abstract class Collector {
    ...
    protected LabelsKeyFactory keyFactory = LabelsKeyFactory.getInstance();
     ...
     * Register the Collector with the default registry.
     */
    public <T extends Collector> T register(String name) {
        CollectorRegistry registry = new CollectorRegistry();
        CollectorRegistry.registry.put(name, registry);
  ...
  /* Various utility functions for implementing Collectors. */
    ...
    abstract void clearIfLastModifiedBefore(long millis);
}
