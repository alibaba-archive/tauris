 ...
 * @date 2018-06-07
 */
public abstract class MultiLineScannerBuilder implements TScannerBuilder {

    TDecoder codec = new PlainDecoder();

    public MultiLineScannerBuilder() {
    }

    @Override
    public TScanner create(InputStream in, TEventFactory factory) {
        return new MultiLineScanner(in, codec, factory);
    }

    public static class MultiLineScanner extends AbstractScanner {
        ...
        public MultiLineScanner(InputStream in, TDecoder codec, TEventFactory factory) {
            super(codec, factory);
