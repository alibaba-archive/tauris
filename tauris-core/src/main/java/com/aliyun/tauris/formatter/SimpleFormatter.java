 ...
 */
@Name("simple")
public class SimpleFormatter implements TEventFormatter {
    ...
    static {
        ...
        p = Pattern.compile(String.format("%%\\{%s\\}", StringUtils.join(ts, "|")));
    }
    ...
    public SimpleFormatter(String expression) {
            ...
            for (Map.Entry<String, Class<? extends Term>> entry : TERM_CLASSES.entrySet()) {
                ...
                if (v != null) {
                    ...
                    try {
                        ...
                        throw new TPluginInitException("invalid expression: '" + expression + "'");
                    }
    ...
    public static SimpleFormatter build(String expr) {
        try {
            SimpleFormatter formatter = new SimpleFormatter(expr);
            formatter.init();
            return formatter;
    ...
    static class DateTimeTerm implements Term {
        ...
        public String parse(TEvent e) {
            if (e != null) {
                return e.getTimestamp().toString(sdf);
            } else {
